...
//        System.out.println("Por favor indica el año a partir del que deseas ver los episodios?");
...
//                ));
        ...
        System.out.println( "Por favor escriba el titulo del episiodio que desea ver ");
        var ingresoTitulo= teclado.nextLine();
        Optional<Episodio> episodioBuscado = episodios.stream()
                .filter(e -> e.getTitulo().toUpperCase().contains(ingresoTitulo.toUpperCase()))
                .findFirst();
//
